        ...
        <div class="container mx-auto">
            <div class="flex items-center justify-between px-4 py-3">
                <div class="hidden md:flex space-x-6">
                    ...
                    <!-- 新增：性别查询（PC端导航栏） -->
                    <a href="${pageContext.request.contextPath}/toQuerygender" class="nav-item text-dark font-bold hover:text-primary transition-colors">性别查询</a>
                     <!-- 新增：年龄查询（PC端导航栏） -->
                      <a href="${pageContext.request.contextPath}/toage" class="nav-item text-dark font-bold hover:text-primary transition-colors">年龄查询</a>
            ...
            <aside class="lg:col-span-3 space-y-6">
                ...
                <div class="bg-white rounded-2xl shadow-lg p-6 card-hover">
                    ...
                    <ul class="space-y-3">
                        ...
                        <!-- 新增：性别查询（左侧快速功能） -->
                        <li>
                            <a href="${pageContext.request.contextPath}/toQuerygender" class="flex items-center p-2 hover:bg-light rounded-lg transition-colors">
                                <i class="fa fa-venus-mars w-8 h-8 rounded-full bg-primary/20 text-primary flex items-center justify-center mr-3"></i>
                                性别查询
                            </a>
                        </li>
                        <li>
            ...
            mobileMenu.innerHTML = `
                <div class="bg-white rounded-2xl p-6 w-4/5 max-w-md">
                    ...
                    <ul class="space-y-4">
                        ...
                        <!-- 新增：性别查询（移动端菜单） -->
                        <li><a href="${pageContext.request.contextPath}/toQuerygender" class="block py-2 border-b border-gray-100 text-dark hover:text-primary">性别查询</a></li>
