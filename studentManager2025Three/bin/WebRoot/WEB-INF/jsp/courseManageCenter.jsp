...
<head>
    ...
    <title>课程管理功能中心</title>
    <script src="https://cdn.tailwindcss.com"></script>
    <link href="https://cdn.jsdelivr.net/npm/font-awesome@4.7.0/css/font-awesome.min.css" rel="stylesheet">
    <style>
        body {
            /* ✅ 核心修复：精准匹配你的实际图片路径 + 背景显示必备配置，必出图 */
            min-height: 100vh;
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        <div class="title">课程管理功能中心</div>
        <div class="card-grid">
            <!-- 新建课程功能卡片 -->
            <div class="card">
                <i class="fa fa-book"></i>
                <h3>新建课程</h3>
                <button class="btn" onclick="window.location.href='${pageContext.request.contextPath}/toAddCourse'">进入操作</button>
            </div>
            <!-- 删除课程功能卡片 -->
            <div class="card">
                <i class="fa fa-trash"></i>
                <h3>删除课程</h3>
                <button class="btn" onclick="window.location.href='${pageContext.request.contextPath}/toDeleteCourse'">进入操作</button>
            </div>
            <!-- 查询课程功能卡片 -->
            <div class="card">
                <i class="fa fa-search"></i>
                <h3>查询课程</h3>
                <button class="btn" onclick="window.location.href='${pageContext.request.contextPath}/toQueryCourse'">进入操作</button>
            </div>
            <!-- 修改课程学分功能卡片 -->
            <div class="card">
                <i class="fa fa-pencil"></i>
                <h3>修改课程学分</h3>
                <button class="btn" onclick="window.location.href='${pageContext.request.contextPath}/toUpdateCourseCredit'">进入操作</button>
            </div>
        </div>
        <div class="back-btn">
