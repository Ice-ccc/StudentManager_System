...
<body>
    <div class="container">
        <div class="title">选课管理功能中心</div>
        <div class="card-grid">
            <!-- 学生选课功能卡片：结构完全保留 -->
            <div class="card">
                <i class="fa fa-plus-circle"></i>
                <h3>学生选课</h3>
                <button class="btn" onclick="window.location.href='toStudentChoose'">进入操作</button>
            </div>
            <!-- 学生退课功能卡片：结构完全保留 -->
            <div class="card">
                <i class="fa fa-minus-circle"></i>
                <h3>学生退课</h3>
                <button class="btn" onclick="window.location.href='toStudentDrop'">进入操作</button>
            </div>
            <!-- 查看选课功能卡片：结构完全保留 -->
            <div class="card">
                <i class="fa fa-search"></i>
                <h3>查看选课</h3>
                <button class="btn" onclick="window.location.href='toViewChoose'">进入操作</button>
            </div>
            <!-- 选课统计功能卡片：结构完全保留 -->
            <div class="card">
                <i class="fa fa-bar-chart"></i>
                <h3>选课统计</h3>
                <button class="btn" onclick="window.location.href='toChooseStat'">进入操作</button>
            </div>
        </div>
        <div class="back-btn">
            <!-- 已修改：文案改为“返回首页”，跳转逻辑改为你的/toMain映射（绝对路径，避免解析错误） -->
