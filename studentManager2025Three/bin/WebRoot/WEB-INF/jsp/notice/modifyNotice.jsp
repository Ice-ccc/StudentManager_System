...
<body>
    <div class="container">
        <h2>修改公告</h2>
        <%-- ✅ 表单提交路径、跳转方法、参数名 完全保留原始代码，一字未改 --%>
        <form action="${pageContext.request.contextPath}/notice/getNoticeForModify" method="post">
            <label>公告ID：</label>
            <input type="text" name="NidStr" required placeholder="请输入要修改的公告ID"/><br>
